...
const NotificationSettings: React.FC = () => {
  ...
  const handleSettingChange = async (setting: keyof NotificationSettingsType, value: boolean) => {
    if (!settings) return;
  ...
  const showPermissionInfo = () => {
    presentAlert({
      ...
      message: `
        <p><strong>Estat actual:</strong> ${hasPermission ? 'Concedit' : 'Denegat'}</p>
      ...
      <IonContent>
              ...
              <IonList>
                <IonItem>
                  ...
                  <IonToggle
                    ...
                    onIonChange={(e) => handleSettingChange('enabled', e.detail.checked)}
                  />
                </IonItem>
                ...
                <IonItem>
                  <IonLabel>
                    ...
                    <p>Notifica quan altres usuaris afegeixen noves localitzacions prop teu</p>
                  </IonLabel>
                  <IonCheckbox
                    checked={settings.newLocations}
                    disabled={!settings.enabled}
                    onIonChange={(e) => handleSettingChange('newLocations', e.detail.checked)}
                  />
                </IonItem>
                ...
                <IonItem>
                  <IonLabel>
                    ...
                    <p>Alerta quan hi ha activitat de bolets prop de la teva ubicació</p>
                  </IonLabel>
                  <IonCheckbox
                    checked={settings.nearbyDiscoveries}
                    disabled={!settings.enabled}
                    onIonChange={(e) => handleSettingChange('nearbyDiscoveries', e.detail.checked)}
                  />
                </IonItem>
                ...
                <IonItem>
                  <IonLabel>
                    ...
                    <p>Informació sobre les millors èpoques per buscar bolets</p>
                  </IonLabel>
                  <IonCheckbox
                    checked={settings.mushroomSeason}
                    disabled={!settings.enabled}
                    onIonChange={(e) => handleSettingChange('mushroomSeason', e.detail.checked)}
                  />
                </IonItem>
                ...
                <IonItem>
                  <IonLabel>
                    ...
                    <p>Notificacions sobre condicions meteorològiques favorables</p>
                  </IonLabel>
                  <IonCheckbox
                    checked={settings.weatherAlerts}
                    disabled={!settings.enabled}
                    onIonChange={(e) => handleSettingChange('weatherAlerts', e.detail.checked)}
                  />
                </IonItem>
              </IonList>
            </IonCardContent>
        ...
        {!hasPermission && (
          <IonCard color="warning">
            ...
            <IonCardContent>
              <p>
                Per rebre notificacions push, necessites concedir permisos al teu dispositiu o navegador.
              </p>
              <br />
              <p>
              ...
              <ul className="ml-4 mt-2">
                <li>• <strong>Android:</strong> Configuració → Apps → Mushroom Finder → Notificacions</li>
                <li>• <strong>iOS:</strong> Configuració → Notificacions → Mushroom Finder</li>
                <li>• <strong>Web:</strong> Icona del cadenat a la barra d'adreces → Notificacions</li>
              </ul>
            </IonCardContent>
          </IonCard>
        )}
